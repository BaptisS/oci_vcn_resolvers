...
mv vcnresolvers_backup.zip $tenancyname.$region.vcnresolvers.$date.backup.zip
rm -f vcnresolvers_backup.zip
rm -f *.logfile
dir=$(pwd)
echo $dir/$tenancyname.$region.vcnresolvers.$date.backup.zip
